...
@section('content')
    ...
    <section class="nd-pagehero nd-pagehero--photo">
        <img class="nd-pagehero__bg" src="{{ asset('site/assets/img/hero_interior.jpg') }}" alt="" aria-hidden="true">
        <div class="nd-wrap">
            <p class="nd-crumb"><a href="{{ route('site.home') }}">홈</a><span>›</span>서비스</p>
            <h1 class="nd-h1">서비스</h1>
            <p class="nd-lead">모집에서 사후관리까지, 단계마다 무엇을 하는지 구체적으로 적었습니다.</p>
        </div>
    </section>

    {{-- ==================== 모집 & 선별 ==================== --}}
    <section class="nd-section" id="recruitment">
        <div class="nd-wrap">
            <div class="nd-split">
                <div class="nd-rise">
                    <span class="nd-eyebrow">01 — Recruitment</span>
                    <h2 class="nd-h2">모집 &amp; 선별</h2>
    ...
    {{-- ==================== 사전 교육 ==================== --}}
    <section class="nd-section nd-section--muted" id="education">
        <div class="nd-wrap">
            <div class="nd-split nd-split--reverse">
                <div class="nd-rise">
                    <span class="nd-eyebrow">02 — Education</span>
                    <h2 class="nd-h2">사전 교육</h2>
                    <p class="nd-lead" style="margin-top:18px">
            ...
            <div class="nd-grid nd-grid--3" style="margin-top:56px">
                ...
                <article class="nd-card nd-rise">
                    <span class="nd-card__no">안전</span>
                    <h3 class="nd-h3">안전 교육</h3>
    ...
    {{-- ==================== 현장 관리 ==================== --}}
    <section class="nd-section" id="management">
        <div class="nd-wrap">
            <div class="nd-split">
                <div class="nd-rise">
                    <span class="nd-eyebrow">03 — Management</span>
                    <h2 class="nd-h2">현장 관리</h2>
                    <p class="nd-lead" style="margin-top:18px">
                        배치가 끝이 아니라 시작입니다.
                ...
                <div class="nd-split__a nd-rise">
                    <div class="nd-plate nd-plate--photo">
                        <img class="nd-plate__img" src="{{ asset('site/assets/img/farm_guidance.jpg') }}" alt="현장에서 근로자에게 작업을 지도하는 장면">
                        <span class="nd-plate__k">6</span>
                        <p class="nd-plate__t">월별 인터뷰 6개 항목</p>
                        <p class="nd-plate__d">급여 · 차별 · 생활 규칙 · 단체 생활 · 건강 · 이탈 징후</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="nd-section nd-band">
        <div class="nd-wrap">
            <div class="nd-sechead nd-sechead--center nd-rise">
                <span class="nd-eyebrow">04 — Administration</span>
    ...
    <section class="nd-section nd-section--muted">
        <div class="nd-wrap">
            <div class="nd-sechead nd-rise">
                <span class="nd-eyebrow">Scope</span>
                <h2 class="nd-h2">누가 무엇을 하는지</h2>
                <p class="nd-lead">역할이 겹치거나 비는 구간이 없도록 미리 나눠 둡니다.</p>
            </div>
            <div class="nd-tablewrap nd-rise" style="margin-top:30px">
                <table class="nd-table">
                    <caption class="nd-sr">단계별 주체와 산출물</caption>
                    <thead>
    ...
    <section class="nd-cta nd-band">
        <div class="nd-wrap">
            <h2 class="nd-h2">어느 단계부터 필요하신가요</h2>
            <p class="nd-lead">전 과정이 아니라 일부 구간만 맡는 것도 가능합니다.</p>
            <div class="nd-btnrow">
                <a class="nd-btn nd-btn--accent" href="{{ route('site.contact') }}">상담 요청</a>
            </div>
        </div>
    </section>
@endsection
