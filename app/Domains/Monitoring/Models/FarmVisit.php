...
class FarmVisit extends Model
{
    ...
    /** 이 방문에 묶어 작성한 근로자별 근무상태 점검표 @return HasMany<WorkReview, $this> */
    public function workReviews(): HasMany
    {
        return $this->hasMany(WorkReview::class, 'farm_visit_id')->orderBy('id');
    }
}
